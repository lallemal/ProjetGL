...
# Base pour un script de test de context de l'extension 
...
# Test pour les fichiers invalides qu'il y a une erreur lors de test_context et 
# vérifie que c'est l'erreur attendue
...
do
  ...
  elif test_context_nodebug $i 2>&1 | grep -q -e "$i:"
  then
...
#Test pour les fichiers de codegen qu'aucune erreur lors de test_context
